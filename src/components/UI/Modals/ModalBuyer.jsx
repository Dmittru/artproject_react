                                            ...
                                            <div className="mt-2">
                                                <div className='mt-4'>
                                                    <div className="mx-auto max-w-7xl px-0 lg:px-0">
                                                        ...
                                                        {/*{GALLERY}*/}
                                                        <ul role="list"
                                                            className="mt-20 grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
                                                            {files.map((file) => (
                                                                <li key={file.source} className="relative">
                                                                    <div
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            <span
                                                                                className="sr-only">View details for {file.title}</span>
                                                                        </button>
                                                                    </div>
